      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center gap-12 lg:gap-24">
        ...
        <div className="max-w-lg mx-auto md:mx-0">
          ...
          <p className="text-gray-400 mb-12 text-lg">
            Create your account today and unlock exclusive AI models, personalized chat history, and seamless intelligent experiences.
          </p>

          <div className="flex flex-col gap-8">
            <div className="flex gap-4 items-start">
              <div className="p-2 bg-gray-800 rounded-lg text-yellow-400 mt-1 border border-gray-700">
                <Zap size={24} />
              </div>
              <div>
                <h3 className="font-bold text-white text-lg">Lightning Fast</h3>
                <p className="text-gray-500 text-sm">Experience real-time AI responses with zero latency</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Join our fast-growing community of creators and developers</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-bold text-white text-lg">Secure & Private</h3>
                <p className="text-gray-500 text-sm">Your chats and data are strictly encrypted and private</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center md:justify-end">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Welcome! Please fill in the details to get started.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-gray-900 border border-gray-700 text-white font-medium text-sm py-2 px-3 rounded-lg hover:bg-gray-700 transition-colors shadow-sm"
            >
